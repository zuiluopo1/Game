...
public class BinaryDataMgr
{
    ...
    public void InitData()
    {
        ...
        LoadTable<T_AI_InfoContainer, T_AI_Info>();//AI数据表
        LoadTable<DmgInfoContainer, DmgInfo>();//伤害数据表
        LoadTable<T_MonsterLev_InfoContainer, T_MonsterLev_Info>();//怪物等级表
        LoadTable<T_PlayerLev_InfoContainer, T_PlayerLev_Info>();//玩家等级表
        
        LoadTable<T_level_Total_InfoContainer, T_level_Total_Info>();//关卡总表
        LoadTable<T_level_Section_InfoContainer, T_level_Section_Info>();//关卡分段表
        LoadTable<T_thing_InfoContainer, T_thing_Info>();//物件表
        
        LoadTable<T_UtilContainer,T_Util>();//通用物件数值表
    }
